...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres.pregghtuzmytcccxlqvp:H0BUtU6eS6Hf40OS@aws-0-sa-east-1.pooler.supabase.com:6543/postgres'
...
# Executar o comando para criar o banco de dados
    with app.app_context():
        ...
        autor = Autor(nome='Davi', email='jhonatan@email.com',
                    senha='6552fstr6467', admin=True)
